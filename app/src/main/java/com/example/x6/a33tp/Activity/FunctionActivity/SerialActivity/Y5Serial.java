...
public class Y5Serial extends Activity {
    ...
    private boolean isSerialTested1 = false,isSerialTested2 = false,isSerialTested3 = false,isSerialTested0 = true;
...
//        serialControl.startSerialPort0();
        ...
        nextTest.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                stepCode.jumpActivity(StepCode.STEP_UART485,Y5Serial.this, Y7orY8orY10Activity.class);
                Y5Serial.this.finish();
            }
        });
    }
    ...
    private void initView() {
        ...
        stepCode = StepCode.getStepCodeClass(Y5Serial.this.getApplicationContext());
