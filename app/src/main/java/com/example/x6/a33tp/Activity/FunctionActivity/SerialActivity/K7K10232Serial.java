...
import com.example.x6.a33tp.Function.SerialKTest;
...
public class K7K10232Serial extends Activity {
    ...
    private SerialKTest serialControl;
    ...
    private boolean isSerialTested1 = false,isSerialTested2 = false,isSerialTested3 = false,isSerialTested0 = false;
    ...
    private void isSerialTested(int i,boolean tempbl){
        switch (i){
            ...
            case 2:
                ...
                break;
            case 3:
                isSerialTested3 = tempbl;
                break;
        }
    }
    private void syncNextTest(){
        if(isSerialTested0 && isSerialTested1 && isSerialTested2 && isSerialTested3 )
    ...
    private void syncUI(int port, Bundle bundle,TextView textView,TextView textView1){
        switch (serialControl.getMsgFlag(bundle)){
            ...
            case SerialControl.RECV_END:
                ...
                if((float)getSerialRecvPack(port)/(float)getSerialSendPack(port) >= 0.75){
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.k232);
        initView();
        serialControl = new SerialKTest(handler);
        ...
        nextTest.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                stepCode.jumpActivity(StepCode.STEP_GPIO,K7K10232Serial.this, Y7orY8orY10Activity.class);
                K7K10232Serial.this.finish();
            }
        });
    }
    ...
    private void initView() {
        ...
        stepCode = StepCode.getStepCodeClass(K7K10232Serial.this.getApplicationContext());
