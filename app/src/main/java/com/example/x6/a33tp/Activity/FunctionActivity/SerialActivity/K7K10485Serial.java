...
public class K7K10485Serial extends Activity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        nextTest.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                stepCode.jumpActivity(StepCode.STEP_GPIO,K7K10485Serial.this, Y7orY8orY10Activity.class);
                K7K10485Serial.this.finish();
            }
        });
    }
    ...
    private void initView() {
        ...
        stepCode = StepCode.getStepCodeClass(K7K10485Serial.this.getApplicationContext());
